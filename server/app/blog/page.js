...
// Exports
module.exports = {
	"twitter-widget": "styles_twitter-widget__WMGLA",
	"post-date": "styles_post-date__mNLdb",
	"post-date-preview": "styles_post-date-preview__syIrO"
};
...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_6__);
    ...
    const tree = {
      ...
      children: [
        ...
        {
      children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 234)), "/home/runner/work/hf-site/hf-site/app/blog/page.tsx"]}]
    },
        {
    ...
    const pages = ["/home/runner/work/hf-site/hf-site/app/blog/page.tsx"]
...
;// CONCATENATED MODULE: ./app/blog/components/TwitterTimeline.jsx
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime.jsx("a", {
                ...
                href: "https://twitter.com/HaxeFlixel?ref_src=twsrc%5Etfw",
                children: "Tweets by HaxeFlixel"
            }),
...
// EXTERNAL MODULE: ./app/blog/styles.module.css
var styles_module = __webpack_require__(3774);
var styles_module_default = /*#__PURE__*/__webpack_require__.n(styles_module);
;// CONCATENATED MODULE: ./app/blog/BlogPosts.tsx




function Blog({ blogFiles  }) {
            ...
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        ...
                        blogFiles.map((data)=>/*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                                children: [
                                    /*#__PURE__*/ jsx_runtime.jsx((link_default()), {
                                        href: `/blog/${data.filename}`,
                                        children: /*#__PURE__*/ jsx_runtime.jsx("h3", {
                                            children: data.title
                                        })
                                    }),
                                    /*#__PURE__*/ jsx_runtime.jsx("div", {
                                        className: `${(styles_module_default())["post-date"]} ${(styles_module_default())["post-date-preview"]}`,
                ...
                /*#__PURE__*/ jsx_runtime.jsx("div", {
                    className: `col-md-4 ${(styles_module_default())["twitter-widget"]}`,
                    children: /*#__PURE__*/ jsx_runtime.jsx(TwitterTimeline, {})
                })
            ]
        })
    });
...
/* harmony import */ var remove_markdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(478);
/* harmony import */ var remove_markdown__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(remove_markdown__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var services_markdownService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2685);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6030);
/* harmony import */ var _BlogPosts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1578);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([services_markdownService__WEBPACK_IMPORTED_MODULE_3__]);
services_markdownService__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
async function getBlogProps() {
    const blogFiles = await (0,services_fileService__WEBPACK_IMPORTED_MODULE_1__/* .getAllFilesInFolder */ .J)(_constants__WEBPACK_IMPORTED_MODULE_4__/* .FILE_PATHS.blog */ .O.blog);
    const blogPosts = blogFiles.map(formatPosts);
    return {
        blogFiles: blogPosts.sort(newestFirst)
    };
}
function formatPosts(blogFile) {
    const { frontMatter , content  } = (0,services_markdownService__WEBPACK_IMPORTED_MODULE_3__/* .getParsedFileContent */ .J)(blogFile, _constants__WEBPACK_IMPORTED_MODULE_4__/* .FILE_PATHS.blog */ .O.blog);
    const contentString = remove_markdown__WEBPACK_IMPORTED_MODULE_2___default()(content);
    const characterLimit = 151;
    return {
        ...frontMatter,
        content: truncateString(contentString, characterLimit),
        filename: blogFile
    };
}
...
async function Index() {
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_BlogPosts__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
        blogFiles: props.blogFiles
    });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [627,580,58,231,626], () => (__webpack_exec__(7404)));
